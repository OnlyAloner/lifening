...
plt.plot(y_train.index, y_train, label='Train Actual', fontsize=25)
plt.plot(y_test.index, y_test, label='Test Actual', fontsize=25)
plt.plot(y_test.index, predict, color='red', label='Predictions', fontsize=25)
